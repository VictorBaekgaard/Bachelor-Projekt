...
cv.options.set(dpi=150, show=False, close=True, verbose=0)
...
sim1 = cv.Sim(pars = pars, interventions = interventions1, label = "Samme restriktioner, samme opsporing", datafile = "superdata.csv")
...
merged.plot(to_plot=['cum_diagnoses','cum_deaths','new_diagnoses'], fig_args=dict(figsize=(15,20)))
merged.plot(to_plot=['r_eff'], fig_args=dict(figsize=(15,10)))